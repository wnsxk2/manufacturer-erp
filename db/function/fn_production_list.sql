...
AS $$                                                                                                                                         
  ...
  BEGIN                                                                                                                                         
      v_employee_name_pattern := TRIM(p_employee_name) || '%';                                                                                 
