...
-- quantity: 1~30
-- order_status_id: gs % 100 기준 25/25/40/10 분포
-- ordered_at: 2025-03-01 ~ 2026-05-20 분산
-- ============================================================
INSERT INTO t_product_order (
    customer_id, product_id, quantity, order_status_id, ordered_at
)
SELECT
    ...
    , CASE
        WHEN (gs % 100) < 25 THEN 1
        WHEN (gs % 100) < 50 THEN 2
...
(1, 1, 50, 3, '2026-05-20 14:30:00+09')
, (2, 3, 12, 2, '2026-05-25 10:00:00+09')
, (5, 7, 8, 1, '2026-05-27 16:45:00+09');
